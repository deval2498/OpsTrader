...
export default function MintTokenModal({isOpen}) {
    useEffect(() => {
        ...
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center">
            <div className="h-[200px] w-[350px] bg-black border-2 flex flex-col gap-2 rounded-md">
                ...
                <div className="flex justify-center">
                    <input name="createUser" className="mx-4 rounded-md p-2" style={{backgroundColor: "#322E2E"}} placeholder="Enter amount..."/>
                </div>
